    ...
    const handleFormSubmit = async (prevState: any, formData: FormData) => {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                toast({ title: "Error", description: "Check your inputs and try again", variant: "destructive" });
                return { ...prevState, error: "Validation failed", status: "ERROR" };
            }
            toast({ title: "Error", description: "Unexpected error has occurred", variant: "destructive" });
        ...
        <form action={formAction} className="startup-form">
            ...
            <div data-color-mode="light">
                ...
                <MDEditor value={pitch} onChange={value => setPitch(value as string)} id="pitch" preview="edit" height={300}
                    style={{ borderRadius: 20, overflow: "hidden" }} textareaProps={{ placeholder: "Describe your idea here" }}
